...
class FactorialUseCase {
    ...
    suspend fun computeFactorial(argument: Long): Result =
...
private fun getComputationRanges(factorialArgument: Long): Array<ComputationRange> {
...
private fun getNumberOfThreads(factorialArgument: Long): Int {
