...
class Exercise5Fragment : BaseFragment() {
    ...
    private lateinit var reputationUseCase: ReputationUseCase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reputationUseCase = compositionRoot.getReputationUsersUseCase
    }
    ...
    override fun onCreateView(
        ...
        btnGetReputation.setOnClickListener {
            job = coroutineScope.launch {
                ...
                val reputation = reputationUseCase.getReputationForUser(
                    edtUserId.text.toString(),
                    getReputationEndpoint
                )
